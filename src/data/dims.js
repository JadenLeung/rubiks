export const DIMS_OBJ = {
    ...
    "Sandwich 2x2" : {type: ["Baby", "Sandwich"], difficulty: 1, scramble: "Normal"},
    "Sandwich" : {type: ["Shape" , "Sandwich"], difficulty: 2, scramble: "Normal"},
    "Earth Cube" : {type: ["Big", "Sandwich"], difficulty: 3, scramble: "Normal"},
    "Snake Eyes" : {type: ["NxN", "Baby"], difficulty: 1.5, scramble: "Middle Slices"},
    "Bandaged 2x2" : {type: ["NxN", "Bandage"], difficulty: 2, scramble: "Normal"},
    "Cube Bandage" : {type: ["NxN", "Bandage"], difficulty: 3, scramble: "Normal"},
    "Slice Bandage" : {type: ["NxN", "Bandage"], difficulty: 3, scramble: "Normal"},
